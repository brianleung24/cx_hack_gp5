                                        ...
                                        <div class="portfolio-info ">
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td><h2> USD '.$row_product['price'].'</h2></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                ...
                <div class="modal-body">
                    <table class="table">
                        <tr>
                            ...
                            <td><h2><input type="number" name="quantity" min="1" max="10" id="qty" style="width: 50px;" value="1"></h2></td>
                        </tr>
                        <tr>
                            <td><h2>Total Cost: USD  </h2></td>
            ...
            $.ajax({
                ...
                success: function(data){
                    if (jQuery.trim(data) === "SUCCESS") {
                        alert("Thanks for ordering! Your product will be delivered soon!");
