    ...
    <div class="container">
        <div class="row">
            <ul class="portfolio-filter text-center">
                ...
                <li><a class="btn btn-default" href="#" data-filter=".branded">Drinks</a></li>
                <li><a class="btn btn-default" href="#" data-filter=".design">Snack</a></li>
                <li><a class="btn btn-default" href="#" data-filter=".folio">Amenities</a></li>
                <li><a class="btn btn-default" href="#" data-filter=".logos">Emergency</a></li>
